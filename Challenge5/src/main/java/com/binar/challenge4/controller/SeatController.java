...
public class SeatController {
    ...
    @PostMapping
    public ResponseEntity<Seat> addSeat(@RequestParam(name = "seat_number") Long seatNumber, @RequestParam(name = "is_available") boolean isAvailable, @RequestParam(name = "studio") String studioName){
